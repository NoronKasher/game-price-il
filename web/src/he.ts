...
export const t = {
  ...
  // Eilat: a VAT-free estimate, labelled as such everywhere it appears.
  depEilat: 'מחירי אילת (ללא מע״מ)',
  depEilatHint: 'מציג כמה היו עולות ההצעות מהחנויות בישראל אילו נקנו באילת, ללא מע״מ',
  depEilatBadge: 'הערכה',
  depEilatTitle: 'מחירי אילת — הערכה, לא ציטוט מהחנות',
  depEilatBody:
    'אילת נמצאת באזור סחר חופשי, ולכן קנייה בעיר פטורה ממע״מ (18%) — ולכן משחקים וקונסולות באמת יוצאים שם זולים יותר. אבל אף חנות ישראלית לא מפרסמת באינטרנט מחיר אילתי נפרד: באתרים מופיע מחיר ארצי אחד הכולל מע״מ, וההנחה ניתנת בסניף.',
  depEilatDigitalNote:
    'ההערכה חלה רק על עותקים פיזיים מחנויות בישראל. רכישה דיגיטלית (Steam, PSN, אקסבוקס וכו׳) מחויבת במע״מ לפי מדינת החשבון ולא לפי המקום שבו אתם נמצאים — נסיעה לאילת לא מוזילה קנייה דיגיטלית.',
  depEilatBody2:
    'לכן המספרים כאן מחושבים על ידינו — המחיר הארצי פחות מע״מ — ומסומנים כהערכה. המחיר בפועל תלוי בסניף, במלאי ובכך שהקנייה אכן מתבצעת באילת, ולעיתים נדרשת הצגת תעודה. מומלץ לאמת מול הסניף לפני נסיעה.',
