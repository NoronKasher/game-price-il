...
export const t = {
  ...
  psnBrowserNone:
    'לא נמצא במחשב דפדפן מבוסס Chromium שאפשר להפעיל, ולכן השחזור האוטומטי לא יעבוד כאן. זה לא משנה באיזה דפדפן אתם גולשים — הדפדפן הזה הוא כלי רקע בלבד. אפשר להתקין כרום/אדג׳, או פשוט להדביק את המזהה ידנית למטה.',
